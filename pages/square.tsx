    ...
    <PortfolioBlock
      data={[
        ...
        },
        {
          ...
          description:
            'Gusto Wallet is a financial product created for employees of Gusto customers (their employers). The visual direction was the driver for differentiating the product as an employee tool. The design team and I worked together (via Figma) on iterating through idea\'s on how to best implement their After Effects animations onto the page. I created a proof of concept to validate my ideas on using <a href=\'https://airbnb.design/lottie/\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-lottie\'>Lottie</a> animations (via <a href=\'https://exchange.adobe.com/creativecloud.details.12557.bodymovin.html\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-bodymovin\'>Bodymovin</a>) with <a href=\'https://code.odopod.com/odo-scroll-animation\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-odoscrollanimation\'>OdoScrollAnimation</a> which is a scroll event listening componet from <a href=\'https://www.odopod.com/\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-odopod\'>Odopod</a>. Once I gained the confidence of the design team with my POC, the team and I began making some <a href=\'https://gusto.com/wallet\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-internet-magic\'>internet magic</a> ✨.',
          image: (
            <Img
          ...
          bullets: [
            ...
            { copy: 'Teams | Marketing, Design, UX, Growth & Product' },
            { copy: '<a href=\'https://github.com/9ntonio/wallet\' target=\'_blank\' rel=\'noopener noreferrer\' class=\'umami--click--square-github-wallet\'>Github | Site file examples</a>' },
          ],
        },
        {
