...
const IndexPage = (props) => (
  <>
    ...
    <Intro>
      ...
      <Highlight>San Francisco</Highlight> 🌉. I'm a engineer who 💖 working on projects that
    ...
    <PortfolioBlock
      data={[
        ...
        },
        {
          ...
          description:
            'Odopod designed and engineered Dolby Laboratories online presence. Our technology powers the site\'s responsive redesign by providing a robust UI toolkit and HTML style guide for content creators. As Technical Director on the project that was equal parts design (there were many style components to the system), as well as front-end integration into the large CMS that was powering the site.',
          image: (
            <Img
